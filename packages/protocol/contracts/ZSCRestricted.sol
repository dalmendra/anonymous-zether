...
contract ZSCRestricted {
	...
	CashToken coin; //Daniel - ao invés de RealDigital coin, usarei CashToken coin;
    ...
    modifier onlyParticipant {
		  //This line is commented out because the client transactions are sent by ADMIN_SIGNER and not by the participant himself.
//        require (coin.authorizedAccounts(msg.sender), "CashTokenDefaultAccount: Not authorized Account");
        _;
    }
